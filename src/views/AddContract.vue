    ...
    <div class="group">
            ...
            <div class="grid grid-cols-2 gap-x-6">
              ...
              <div>
                ...
                <input
                  id="onSiteEngineer"
                  type="checkbox"
                  v-model="project.onSiteEngineer"
                />
              </div>
          ...
          <div class="subgroup">
            ...
            <div class="">
              ...
              <div class="flex">
                ...
                <InputNumber
                  class="w-full p-0 self-center focus:outline-none rounded-none"
                  v-model="project.internalCost"
                  inputId="integeronly"
                />
              </div>
            </div>
        ...
        <div class="grid grid-cols-2 gap-x-4">
          <div class="">
            ...
            <textarea
              ...
              v-model="project.contractDescription"
            ></textarea>
          </div>
      ...
      <div class="flex justify-end gap-2">
        <button
          ...
          v-on:click="submitContract('Draft')"
        >
          Save Draft
        </button>
        <button
          class="bg-green-500 p-2 w-32 text-white rounded-md"
          v-on:click="submitContract('Pending')"
        >
          Submit
        </button>
      </div>
...
const addCustomer = async () => {
  if (
    typeof project.value.customer == "string" &&
    project.value.customer != ""
  ) {
    var checkExist = customerList.value.data.find(
      ({ customer_name }) =>
        customer_name.toLowerCase() === project.value.customer.toLowerCase(),
    );
...
const submitContract = async (status) => {
  ...
  try {
    ...
    toast.add({
      ...
      detail: projectResponse.data.message,
      life: 5000,
    });
    setTimeout(() => {
