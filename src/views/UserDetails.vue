<template>
  <h4 class="text-2xl font-semibold mb-4">User Info</h4>
  <div class="flex gap-5">
    ...
    >
      <section class="flex gap-5 justify-center">
        <div
          class="h-36 w-72 bg-green-500 flex flex-col z-50 p-3 shadow-sm shadow-gray-400 rounded-md select-none text-white"
        >
