<template>
  <div class="">
    ...
    <button @click="uploadFile()" class="bg-black text-white p-1 mt-2">
      Add Form
    </button>

    <a
      href="https://pocketbase.ictincub.my.id/api/files/nh8a6wpfc1smgyp/bhrma1ohs1rjjt1/932_article_text_1711_2_10_20201002_SCcNJ97QIj.pdf?token="
...
onMounted(async () => {
  const record = await pb
    .collection("files")
    .getFirstListItem('project_id="test2"');
});
</script>
